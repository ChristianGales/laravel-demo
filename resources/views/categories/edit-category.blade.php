...
@section('content')
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-500">
            Update the details for "Electronics".
        </p>
    </div>
        ...
        <form class="space-y-5">
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select
                        id="icon"
                        class="w-full rounded-lg border border-slate-300 px-4 py-2 outline-none focus:border-blue-500">
                        <option value="fa-laptop" selected>Laptop</option>
            ...
            <div>
                ...
                <textarea
                    id="description"
                    rows="4"
                    class="w-full rounded-lg border border-slate-300 px-4 py-2 outline-none focus:border-blue-500">Computers, keyboards, monitors, and other electronic devices.</textarea>
            </div>
